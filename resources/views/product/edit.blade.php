	...
	<div class="container-fluid">
		...
		<div class="card mb-4">
			<div class="card-body">
                ...
                {{ Html::modelForm($product ,'PUT', route('product.update', $product->id))->acceptsFiles()->open() }} // model form different from normal form is that we use it when we throw obj into form ($product)
